...
const toggleOn = () => {
  ...
  toggleItems.style.animation = "slideFromRight 1s";
  siteLogo.style.animation = "fadeOut 2s";
  siteLogo.style.display = "none";
  toggleMenu.style.animation = "slideFromRight 1s";
...
const toggleOff = () => {
  ...
  toggleItems.style.animation = "slideFromLeft 1s";
  siteLogo.style.animation = "fadeIn2 1s";
  siteLogo.style.display = "inline";
  toggleMenu.style.animation = "slideFromLeft 1s";
